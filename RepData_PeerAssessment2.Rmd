---
title: "RepData Project 2: Damage and Health Effects of Weather Events"
output: 
  html_document:
    keep_md: true
---
...
propdamage = damageCollated[damageCollated$category == "Property Damage", c(1, 3)]
print(xtable(arrange(propdamage, desc(value))), type = "html", comment = FALSE)
```

#### Crop Damage
```{r results = "asis", echo = FALSE}
cropdamage = damageCollated[damageCollated$category == "Crop Damage", c(1, 3)]
print(xtable(arrange(cropdamage, desc(value))), type = "html", comment = FALSE)
```
...
#### Injuries
```{r results = "asis", echo = FALSE}
injuries = healthCollated[healthCollated$category == "Injuries", c(1, 3)]
print(xtable(arrange(injuries, desc(value))), type = "html", comment = FALSE)
```

#### Fatalities
```{r results = "asis", echo = FALSE}
fatalities = healthCollated[healthCollated$category == "Fatalities", c(1, 3)]
print(xtable(arrange(fatalities, desc(value))), type = "html", comment = FALSE)
```
<p>
**And a picture:**
