---
title: "RepData Project 2: Damage and Health Effects of Weather Events: 1950 - 2011"
output: 
  html_document:
    keep_md: true
---
...
```
Only retain the rows that contain damage, injuries or fatalities; damage exponents must be in the accepted set. We can also discard most of the columns.
